  ...
  if (products.length === 0) {
    return (
      <div className="text-center py-12">
        <div className="max-w-md mx-auto text-tertiary">
          ...
          <h3 className="text-lg font-medium text-tertiary mb-2">No products found</h3>
          <p className="text-tertiary/90">Try adjusting your search or filter criteria.</p>
        </div>
      </div>
    );
  }
