      ...
      <div className={`min-h-screen bg-primary text-tertiary ${className}`}>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-tertiary">Your Cart</h1>
            <Link to="/shop" className="inline-flex items-center gap-2 text-tertiary hover:text-primarySupport transition-colors font-medium">
              <ArrowLeft className="w-5 h-5" />
              Continue Shopping
            </Link>
          </div>
          <div className="bg-primarySupport shadow-lg p-12 text-center">
            <div className="w-24 h-24 flex items-center justify-center mx-auto mb-6">
              <CartIcon className="w-12 h-12 text-tertiary" />
            </div>
            <h2 className="text-3xl font-bold text-tertiary mb-4">Your cart is empty</h2>
            <p className="text-xl text-tertiary/90 mb-8 max-w-md mx-auto">Start adding some amazing products to your cart and fuel your performance!</p>
  ...
  return (
    <div className={`min-h-screen bg-primary text-tertiary ${className}`}>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-tertiary">Your Cart</h1>
          <p className="text-xl text-tertiary/90 mb-6">{cart.itemCount} {cart.itemCount === 1 ? 'item' : 'items'} in your cart</p>
          <Link to="/shop" className="inline-flex items-center gap-2 text-tertiary hover:text-primarySupport transition-colors font-medium">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-8 overflow-hidden">
          <div className="lg:col-span-2 overflow-hidden">
            <div className="bg-primarySupport shadow-lg border border-black/20 overflow-hidden">
          ...
          <div className="lg:col-span-1">
            <div className="bg-primarySupport shadow-lg border border-black/20 p-6 sticky top-24">
              <h2 className="text-xl font-semibold text-tertiary mb-6">Order Summary</h2>
              <div className="space-y-4 mb-6">
                <div className="flex justify-between items-center"><span className="text-tertiary/90">Subtotal</span><span className="font-semibold">{formatPrice(cart.total)}</span></div>
                <div className="flex justify-between items-center"><span className="text-tertiary/90">Shipping</span><span className="font-semibold text-tertiary/70">Calculated at checkout</span></div>
                <div className="flex justify-between items-center"><span className="text-tertiary/90">Tax</span><span className="font-semibold">Included</span></div>
              ...
              <div className="space-y-3">
                ...
                <button onClick={clearCart} className="w-full text-tertiary py-3 px-6 border-2 border-tertiary/40 hover:bg-tertiary/10 transition-colors font-medium">Clear Cart</button>
              </div>
              <div className="mt-6 pt-6 border-t border-black/20">
                <div className="text-center">
                  <p className="text-sm text-tertiary/80 mb-3">Secure Checkout</p>
                  <div className="flex justify-center items-center gap-4">
                    <div className="flex items-center gap-1 text-xs text-tertiary/80"><CreditCard className="w-4 h-4" /> PayFast</div>
                    <div className="flex items-center gap-1 text-xs text-tertiary/80"><Package className="w-4 h-4" /> Free Shipping</div>
                  </div>
                </div>
              </div>
            </div>
