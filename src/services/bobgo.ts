...
export class BobGoService {
   ...
   * Transform BobGo rates to our ShippingOption format
   */
  private transformRatesToShippingOptions(rates: BobGoRate[]): ShippingOption[] {
  ...
  /**
   * Get default shipping option (free shipping disabled for testing)
   */
  getDefaultShippingOption(cartTotal: number): ShippingOption {
    ...
    // Return a default standard shipping option (will be updated with actual rates)
    return {
      id: 'standard-shipping',
      name: 'Standard Shipping',
      description: 'Standard delivery service',
      price: 0, // Will be updated with actual rates
      currency: 'ZAR',
