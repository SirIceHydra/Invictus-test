    ...
    <div className="min-h-screen bg-primary text-tertiary">
      ...
      <section className="py-20 relative bg-primary">
        ...
        <div className="relative z-10 container mx-auto px-4 py-8">
          <h1 className="text-center mb-4 text-tertiary">BLOG</h1>
      ...
      <div className="bg-primary border-t-2 border-white border-b-2 border-white md:sticky md:top-0 md:z-10">
